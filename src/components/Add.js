                ...
                <Form.Group className="mb-1" controlId="formSkills">
                    <div className="col-md-12">
                        ...
                        <div className='form-control'>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox3" name="skills" onChange={handleChange} value="Recruitment" />
                                <label class="form-check-label" for="inlineCheckbox3">Recruitment</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox3" name="skills" onChange={handleChange} value="Optimization" />
                                <label class="form-check-label" for="inlineCheckbox3">Optimization</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox3" name="skills" onChange={handleChange} value="App Development" />
                                <label class="form-check-label" for="inlineCheckbox3">App Development</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox3" name="skills" onChange={handleChange} value="Frontend Technology" />
                                <label class="form-check-label" for="inlineCheckbox3">Frontend Technology</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox3" name="skills" onChange={handleChange} value="Backend Technology" />
