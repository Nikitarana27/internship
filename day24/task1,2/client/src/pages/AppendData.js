...
export default function AppendData() {
  ...
  const Append_data = async (e) =>{
    ...
    let localHost = "http://localhost:5000/AppendData";
  ...
  return (
    ...
    <div className="div m-3">
        ...
        <form name="form" method="get" onSubmit={Append_data}>
          <div className="mb-4">
            ...
            <button type="submit" className="btn btn-success mt-3  rounded-3">Append in File</button><br></br>
